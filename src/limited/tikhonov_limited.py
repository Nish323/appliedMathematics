...
def calc_matrixA(img, angle_division, s_division, start_angle=-90, end_angle=90): #角度は-pi/2 - pi/2, sは-sqrt(2) - sqrt(2)でとる
...
#
#####################################################
def tikhonov(img, angle_division, s_division, alpha, sg_error, start_angle, end_angle): #逆問題を解く
  figuresize = img.shape[0]
