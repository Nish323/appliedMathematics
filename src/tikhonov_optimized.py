...
def run_reconstruction(bb, cc, dd, rerror, img_path='img/image.png', img_size=128, output_dir='img/optimized'):
    """
    画像再構成を実行する関数
    ...
    filename = f'{output_dir}/image_{bb}_{cc}_{int(dd)}_{int(rerror*100):03d}.png'
